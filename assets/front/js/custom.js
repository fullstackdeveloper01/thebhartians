(function($) {
    ...
    */
    ...
    //     }
    // });
    // $('.widget > ul > li > ul> li> .has-child').on('click', function(e) {
    //     $('a.category-link').removeClass('active');
    //     if ($(this).parent('li').hasClass('open')) {
    //         $(this).parent('li').removeClass('open');
    //         $(this).parent('li a.category-link').removeClass('active');
    //         e.stopPropagation();
    //     } else {
    //         $(this).parent('li').addClass('open');
    //         $(this).parent('li a.category-link').addClass('active');
    //         e.stopPropagation();
    //     }
    // });
    $(".widget li .has-child").on("click", function (e) {
    ...
    $('.quantity').each(function() {
        ...
        btnUp.on('click', function() {
            ...
            console.log(max, min, newVal, stck)
