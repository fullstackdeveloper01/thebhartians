(function ($) {
	...
	$(document).ready(function () {
		...
		var sizes =  $(".product-size .siz-list li.active").length > 0

		?  $(".product-size .siz-list li.active")
		...
		var size_qty =
			...
			$(".product-size .siz-list li.active").length > 0
		...
		var size_price = $(".product-size .siz-list li.active").length > 0
		...
		var size_key = $(".product-size .siz-list li.active").length > 0
