...
Route::prefix('admin')->group(function() {
  ...
  Route::get('/order/{id}/label-invoice', 'Admin\OrderController@invoice2')->name('admin-order-invoice2');
  Route::get('/order/{id}/label-print', 'Admin\OrderController@printpage2')->name('admin-order-print2');
...
/////////////////////////////// ////////////////////////////////////////////
  ...
  Route::post('/products/upload/update-ajax/{id}', 'Admin\ProductController@uploadUpdateAjax')->name('admin-prod-upload-update-ajax');
