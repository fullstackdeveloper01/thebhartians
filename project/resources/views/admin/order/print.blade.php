...
<body onload="window.print();">
    ...
    <div class="invoice-wrap">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6" style="float: left;"> 
                        ...
                        <div class="invoice__logo text-left; ">
                           ...
                           <img style="width:250px;height:100px" src="{{ asset('assets/images/'.$gs->invoice_logo) }}" alt="woo commerce logo">

                        </div>

                    </div>

                    <div class="col-lg-6" style="float:right; margin-top: 25px; margin-right: 50px;">
            ...
            <div class="invoice__metaInfo" style="margin-top:0px;">
                ...
                <div class="col-lg-6">
                        ...
                        <div class="invoice__orderDetails" style="margin-top:5px;">
                           ...
                           <span><strong>{{ __('Zip Code') }}</strong>: {{ $order->shipping_zip == null ? $order->customer_zip : $order->shipping_zip }}</span><br>

                           <span><strong>{{ __('Country') }}</strong>: {{ $order->shipping_country == null ? $order->customer_country : $order->shipping_country }}</span><br>
                           
                           <span><strong>{{ __('Mobile No.') }}</strong>: {{ $order->shipping_phone == null ? $order->customer_phone : $order->shipping_phone }}</span>
                ...
                <div class="col-lg-6" style="width:50%;">
                        ...
                        <div class="invoice__orderDetails" style="margin-top:5px;">
                            ...
                            <span><strong>{{ __('Zip Code') }}</strong>: {{ $order->customer_zip }}</span><br>

                            <span><strong>{{ __('Country') }}</strong>: {{ $order->customer_country }}</span><br>

                            <span><strong>{{ __('Mobile No.') }}</strong>: {{ $order->customer_phone }}</span>
        ...
        <div class="row footer-bottom" style=""> 
            
            <div class="col-lg-12 text-center inner-footer" style="">
                <p class=" invoice_table" style="padding-left: 60px;">
                    <span><strong>{{ __('Address') }}</strong>: Office No 03, Vitthal mandir lane, opp. Kutirodyog upahargruha, near Kopineshwar mandir, </br>station road (Subhash Road), Thane(W) , Maharashtra – 400601</span><br>
                </p>
            </div>
        </div>
