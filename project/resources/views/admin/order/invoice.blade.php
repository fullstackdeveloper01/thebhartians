    ...
    <div class="order-table-wrap">
        ...
        <div class="invoice-wrap">
           ...
           @if($order->dp == 0)
            ...
            <div class="row">
                <p class="text-center">
                <span><strong>{{ __('Address') }}</strong>: Office No 03, Vitthal mandir lane, opp. Kutirodyog upahargruha, near Kopineshwar mandir, station road (Subhash Road), Thane(W) , Maharashtra – 400601</span><br>
                </p>
            </div>
