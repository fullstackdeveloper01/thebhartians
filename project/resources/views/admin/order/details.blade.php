                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="special-box">
                                        ...
                                        <div class="footer-area">
                                            ...
                                            <a href="{{ route('admin-order-invoice2',$order->id) }}" class="mybtn1"><i class="fas fa-eye"></i> {{ __('View Address') }}</a>
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-lg-12 order-details-table">
                                        ...
                                        <div class="mr-table">
                                            ...
                                            <td><img src="{{filter_var($product['item']['photo'], FILTER_VALIDATE_URL) ?$product['item']['photo']:asset('assets/images/products/'.$product['item']['photo'])}}"></td>
