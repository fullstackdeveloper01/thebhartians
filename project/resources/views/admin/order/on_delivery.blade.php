...
<input type="hidden" id="headerdata" value="{{ __('ORDER') }}">
                    ...
                    <div class="content-area">
                        <div class="mr-breadcrumb">
                            <div class="row">
                                <div class="col-lg-12">
                                        <h4 class="heading">{{ __('On Delivery Orders') }}</h4>
                                        <ul class="links">
                                            <li>
                                            ...
                                            <li>
                                                <a href="{{ route('admin-orders-all') }}?status=on_delivery">{{ __('On Delivery Orders') }}</a>
                                            </li>
                                        </ul>
                                </div>
                            </div>
...
(function($) {
        ...
        var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-order-datatables','on_delivery') }}',
               columns: [
