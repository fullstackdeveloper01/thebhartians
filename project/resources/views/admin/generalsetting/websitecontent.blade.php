                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                              <div class="custom-control custom-radio d-inline-block mr-5">
                                  <input type="radio" class="custom-control-input" id="header_color"  name="header_color" value="light" @if($gs->header_color =='light') checked @endif>
                                  <label class="custom-control-label" for="header_color">{{__('Light')}}</label>
                              </div>
                              <div class="custom-control custom-radio d-inline-block mr-5">
                                  <input type="radio" class="custom-control-input" id="header_color1"  name="header_color" value="dark" @if($gs->header_color =='dark') checked @endif>
                                  <label class="custom-control-label" for="header_color1">{{__('Dark')}}</label>
                              </div>
                          </div>
                        </div>
                          ...
                          <div class="row justify-content-center">
                            ...
                            <div class="row justify-content-center">
                              ...
                              <div class="row justify-content-center">
                                ...
                                <div class="col-lg-6">
                                    <div class="tawk-area">
                                      <textarea class="input-field" name="return_policy_text">{{$gs->return_policy_text}}</textarea>
                                    </div>
                                </div>
                              </div>
