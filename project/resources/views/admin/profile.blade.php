							...
							<div class="row">
								...
								<div class="col-lg-4">
									...
									<div class="left-area">
										...
										<h4 class="heading">{{ __('Security Key') }} *</h4>
								...
								<div class="col-lg-7">
									...
									<input type="number" pattern="[0-9]{4}" maxlength="4" class="input-field" name="security_key" placeholder="{{ __('Enter 4 digit security number') }}"  required="" value="{{$data->security_key}}">
