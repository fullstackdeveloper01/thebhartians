														...
														<div class="body-area">
															...
															<div class="row">
																...
																<div class="col-lg-12">
																	...
																	<input type="text" class="input-field" placeholder="{{ __('BH') }}" name="sku" required="" value="{{ $data->sku }}">
													...
													<div class="product-description">
														...
														<div class="body-area">
															...
															<div class="row">
															  ...
															  <input type="file" name="product_photo" class="hidden" id="product_photo" accept="image/*">

															  <input type="hidden" id="feature_photo" name="photoss" value="{{ $data->photo }}" accept="image/*">
																...
																<div class="row">
																	...
																	<div class="col-lg-12">
																		...
																		<input name="base_price" step="0.1" type="number" class="input-field" placeholder="e.g 20" value="{{round($data->base_price * $sign->value , 2)}}" min="0" required="">
																...
																<div class="row">
																	...
																	<input name="previous_price" type="number" class="input-field" placeholder="e.g 20" step="0.1" min="0" value="{{round($data->previous_price * $sign->value , 2)}}" >
...
(function($) {
  ...
  jQuery(document).on('submit', '#form-gallery' ,function() {
...
(function($) {
  ...
  $(document).on('click', '#landscape' ,function() {
	...
	jQuery(document).on('change', "#product_photo",function(e) {

		e.preventDefault(); 
		var datathis = this; 
		var fd = new FormData();
		var file = jQuery(document).find('#product_photo');
		var individual_file = file[0].files[0]; 
		fd.append('image', individual_file); 
		$('#landscape').html('<img src="'+URL.createObjectURL(event.target.files[0])+'" alt=""> <div class="col-sm-6">');
		jQuery.ajax({
			type:    "POST",
			url:     "{{route('admin-prod-upload-update-ajax',$data->id)}}",        
			data: fd,
			dataType: 'json',
			contentType: false,
			processData: false, 
