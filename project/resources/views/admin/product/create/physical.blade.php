														...
														<div class="body-area">
															...
															<div class="row">
																...
																<div class="col-lg-12">
																	...
																	<input type="text" class="input-field" placeholder="{{ __('BH') }}" name="sku" required="" value="">
													...
													<div class="product-description">
														...
														<div class="body-area">
															...
															<div class="row">
																...
																<input name="base_price" step="0.1" type="number" class="input-field" placeholder="{{ __('e.g 20') }}" min="0" required="">
															...
															<div class="row">
																...
																<div class="col-lg-12">
																	...
																	<input name="previous_price" type="number" class="input-field" placeholder="{{ __('e.g 20') }}" step="0.1"  min="0">
...
// Gallery Section Insert
  ...
  $("#product_photo").change(function(){
	...
	var total_file=document.getElementById("product_photo").files.length;
...

	{
		...
		$('#landscape').html('<img src="'+URL.createObjectURL(event.target.files[i])+'" alt=""> <div class="col-sm-6">');
	} 
