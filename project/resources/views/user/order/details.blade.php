                                ...
                                <div class="billing-add-area">
                                    <div class="row"> 
                                        <div class="col-md-6">
                                            ...
                                            <p>{{ __('Payment Status :') }}
                                                @if($order->payment_status == 'Pending')
                                                    <span class='badges badge-danger'>{{ __('Unpaid') }}</span>
                                                @else
                                                    <span class='badges badge-success'>{{ __('Paid') }}</span>
                                                @endif
                                            </p>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td data-label="{{ __('Total') }}">
                                                    <div>
                                                        {{ \PriceHelper::showCurrencyPrice(($product['item_price'] * $product['qty'] ) * $order->currency_value) }} <small>{{ $product['discount'] == 0 ? '' : '('.$product['discount'].'% '.__('Off').')' }}</small></small>
                                                    </div>
                                                </td>
