                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @foreach($convs as $conv)
                          ...
                          <tr class="conv row-mess-{{$conv->id}}">
                            ...
                            <td data-label="{{ __('Actions') }}">
                              <div>
                                ...
                                <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#confirm-delete" data-id="{{$conv->id}}" data-href="{{route('user-message-delete',$conv->id)}}" class="link remove mybtn1"><i class="fa fa-trash"></i></a>
                              </div>
                            </td>
          ...
          <h4 class="modal-title d-inline-block">{{ __('Confirm Delete ?') }}</h4>
              ...
              <p class="text-center">{{ __('Do you want to proceed?') }}</p>
                  ...
                  <div class="modal-footer justify-content-center">
                      <button type="button" class="btn btn-default close" data-bs-dismiss="modal" aria-label="Cancel">{{ __('Cancel') }}</button>
                      <a class="btn btn-danger btn-ok" data-id="0">{{ __('Delete') }}</a>
                  </div>
              </div>
          </div>
      </div>
