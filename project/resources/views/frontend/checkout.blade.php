   ...
   <div class="container">
      <div class="row">
                        ...
                        <div class="content-box">
                           <div class="content">
                              ...
                              <div class="personal-info">
                                 <h5 class="title">  {{ __('Contact information') }} : </h5>
                                 @if (!Auth::check())
                                 <span class="">Already have an account? <a class="" href="{{url('user/login')}}">Log in</a></span>
                                 @endif
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                       ...
                                       name="personal_email" placeholder="{{ __('Enter Email Address') }}"
                                 ...
                                 <div class="row">
                                    <div class="col-lg-12 mt-3">
                                       <input checked class="styled-checkbox" id="open-pass" type="checkbox"
                                          value="1" name="pass_check" readonly>
                                       <label for="open-pass">{{ __('Create an account ?') }}</label>
                                    </div>
                                 </div>
                                 <div class="row set-account-pass d-nones">
                                    <div class="col-lg-6">
                           ...
                           <div class="content">
                              <div class="order-area">
                                 <div class="row">
                                    ...
                                    <div class="col-md-8"><p  class="ppp-email"></p></div>
                                    <div class="col-md-2"><a href="javascript:void(0)" class="ppp-emailchange">Change</a></div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-2"><p>Ship to</p></div>
                                    <div class="col-md-8"><p  class="ppp-billing"></p></div>
                                    <div class="col-md-2"><a href="javascript:void(0)" class="ppp-addresschange">Change</a></div>
                                 </div>
                              ...
                              <div class="row">
                                 ...
                                 <div class="packeging-area" id="shipping-method-area">
                                    <h4 class="title">{{ __('Shipping Method') }}</h4>
                                    @foreach($shipping_data as $data)
                                    <div class="radio-design">
                                       <input type="radio" class="shipping" data-form="{{$data->title}}" id="free-shepping{{ $data->id }}" name="shipping2" value="{{ round($data->price * $curr->value,2) }}" {{ ($loop->first) ? 'checked' : '' }}>
                        ...
                        <div class="content-box">
                           <div class="content">
                              <div class="order-area">
                                 ...
                                 <div class="row">
                                    <div class="col-md-2"><p>Method</p></div>
                                    <div class="col-md-8"><p  class="ppp-shipping"></p></div>
                              ...
                              <div class="row {{ $digital == 1 ? 'd-none' : '' }}">
                                 <div class="col-lg-12 mt-3 d-flex">
                                    <input class="stylued-checkbox" id="billing-diff-address4" checked name="is-shiiping-abb" type="checkbox"
                                       value="pickup">
                                    <label for="billing-diff-address4">{{ __('Same as billing address?') }}</label>
                                 </div>
                                 <div class="col-lg-12 mt-3 d-flex">
                                    <input class="styled-checkbox" id="ship-diff-address" name="is-shiiping-abb" type="checkbox"
                                       value="shipto">
                                    <label for="ship-diff-address">{{ __('Use a different shipping address?') }}</label>
                                 </div>
                              </div>
         ...
         <div class="col-lg-4">
            ...
            <div class="content-box">
               <div class="content order-box mb-2">
                  <div class="order-area">
                     @foreach($products as $product)
                     <div class="order-item">
                        <div class="product-img">
                        <p class="qttotal">{{ $product['qty'] }} </p>
                           <div class="d-flex">
               ...
               <div class="order-box">
                  <h4 class="title d-none">{{ __('PRICE DETAILS') }}</h4>
                  ...
                  <div class="cupon-box">
                    <!--  <div id="coupon-link">
                     ...
                     <form id="check-coupon-form" class="coupon" style="display:block;">
                        <input type="text" placeholder="{{ __('Discount code') }}" id="code" autocomplete="off">
                  ...
                  <ul class="order-list">
                     ...
                     <li class="total-price">
                        ...
                        <p class="total-cost-dum" id="shipping-cost-final">
                           Free
                        </p>
                  </li>
                  </ul>
...
<script type="text/javascript">
   jQuery(document).ready(function(){ 
      var ppemail = jQuery("#personal-email").val(); 
      jQuery('.ppp-email').text(ppemail);

      var shippinglabel = jQuery('#shipping-method-area input[name="shipping2"]:checked').parent().find('label').html(); 
      jQuery('.ppp-shipping').html(shippinglabel);

      jQuery(document).on('change', 'input[name="shipping2"]',function(e) { 
         jQuery(this).parent().find('label').html(); 
         jQuery('.ppp-shipping').html(shippinglabel);
      });
      
      jQuery(document).on('blur', "#personal-email",function(e) { 
         var ppemail = jQuery(this).val();
         jQuery('.ppp-email').text(ppemail); 
      });

      jQuery(document).on('click', ".ppp-emailchange",function(e) { 
         jQuery('#personal-email').focus();
         jQuery('.tab-content .tab-pane').removeClass('active');
         jQuery('#pills-step1').addClass('active');

         jQuery('ul.nav .nav-item .nav-link').removeClass('active');
         jQuery('#pills-step1-tab').addClass('active');
         jQuery('#pills-step2-tab').addClass('disabled');
      });
      jQuery(document).on('click', ".ppp-addresschange",function(e) { 
      ...
      jQuery(document).on('blur', "#select_country, #show_state",function(e) { 
         showNewAddressBilling();
      });
      ...
      jQuery(document).on('blur', 'input[name="customer_address"], input[name="customer_city"], input[name="customer_zip"]',function(e) { 
         showNewAddressBilling();
      });

      function showNewAddressBilling() {
         var ppaddress = '';

         var vvcountry = jQuery('#select_country').val();
         var customer_address = jQuery('input[name="customer_address"]').val();
         var customer_city = jQuery('input[name="customer_city"]').val();
         var customer_zip = jQuery('input[name="customer_zip"]').val();
         var customer_state = jQuery('#show_state option:selected' ).text();
         
         if(customer_address != '')
         {
            ppaddress +=  customer_address+', ';
         } 

         if(customer_zip != '' && customer_zip != null && typeof customer_zip !== "undefined")
         {
            ppaddress +=  customer_zip+', ';
         } 

         if(customer_city != '' && customer_city != null && typeof customer_city !== "undefined")
         {
            ppaddress +=  customer_city+', ';
         } 

         if(customer_state != '' && customer_state != null && typeof customer_state !== "undefined")
         {
            ppaddress +=  customer_state+', ';
         }
         if(vvcountry != '' && vvcountry != null && typeof vvcountry !== "undefined")
         {
            ppaddress +=  vvcountry;
         }
         console.log(ppaddress);
         jQuery('.ppp-billing').html(ppaddress);
      }
...
jQuery(document).on('blur', "#customer_name",function(e) {
    var vaall = jQuery(this).val();
   $('#personal-name').val(vaall);
});

jQuery(document).ready(function(){
   var shipping = jQuery('#shipping-method-area input[name="shipping2"]:checked').val(); 
   $('#shipping-cost-final').text('{{ $curr->sign }}'+shipping);
});
   ...
   $('#shipping-cost-final').text('{{ $curr->sign }}'+mship);
   ...
   let original_tax = 0;
   	...
   	function tax_submit(country_id,state_id){
         console.log('country_id', country_id, 'state_id', state_id)
   		$('.gocover').show();
   ...
   $('input[name="is-shiiping-abb"]').on( "change", function() {
      $('input[name="is-shiiping-abb"]').prop('checked', false);
      $(this).prop('checked', true);

      if($("#ship-diff-address").is(':checked')){
