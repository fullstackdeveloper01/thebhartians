                    ...
                    <div class="table-responsive">
                        ...
                        <tr class="woocommerce-cart-form__cart-item cart_item">
                            ...
                            <td class="product-name">
                                ...
                                <b>{{ __('Size') }}</b>:  <span clas="size-bar"> <strong> {{$product['size']}}</strong></span>
                                </div>
                                @endif
                            </td>
                            ...
                            <td class="product-quantity">
                                ...
                                <div class="quantity">
                                    <input readonly id="qty{{$product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values'])}}" class="qttotal" type="number" name="quantity"  value="{{ $product['qty'] }}">
                                </div>
                            </td>
                            @else
                            <td class="product-quantity">
                            ...
                            <td class="product-remove">
                                <a href="#" class="remove cart-remove" data-class="cremove{{ $product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values']) }}" data-href="{{ route('product.cart.remove',$product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values'])) }}"><span style="font-size:10px;">Remove</span></a>
                            </td>
                        </tr>
                       @endforeach
                    </table>
