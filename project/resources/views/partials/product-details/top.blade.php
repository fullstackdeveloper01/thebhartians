                    ...
                    <div class="images-inner">
                        <div class="woocommerce-product-gallery woocommerce-product-gallery--with-images woocommerce-product-gallery--columns-4 images" data-columns="4" style="opacity: 1; transition: opacity 0.25s ease-in-out 0s;">
                            <figure class="woocommerce-product-gallery__wrapper">
                                <div class="bg-light">
                                    <img class="zoom-img" id="responsive_img" src="{{filter_var($productt->photo, FILTER_VALIDATE_URL) ?$productt->photo:asset('assets/images/products/'.$productt->photo)}}" alt="Thumb Image" data-zoom-image="{{filter_var($productt->photo, FILTER_VALIDATE_URL) ?$productt->photo:asset('assets/images/products/'.$productt->photo)}}" />
                                </div>

                                <div id="gallery_09" class="product-slide-thumb">
                                    <div class="owl-carousel thumb-carousel dot-disable nav-arrow-middle owl-mx-5">
                      ...
                      <div class="pro-details">
                         <div class="pro-info">
                              ...
                              <p class="price">
                                  ...
                                  @if(!empty($productt->previous_price))
                         ...
                         @if ($productt->stock_check == 1)
                              ...
                              <div class="product-size product-colors">
                                  <p class="title">{{ __('Size :') }}</p>
                                  <ul class="siz-list color-lists">
