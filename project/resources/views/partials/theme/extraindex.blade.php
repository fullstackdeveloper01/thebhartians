...
@endif
    ...
    <footer class="full-row footer-upper">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="footer-widget mb-5">
                        <div class="footer-logo mb-4">
                            ...
                            <a href="{{ route('front.index') }}"><img class="lazy" src="{{url('/assets/images/1677749179LogoBhartianspng.png')}}" alt="Image not found!" /></a>
                        </div>
                        <div class="widget-ecommerce-contact">
                            ...
                            <div class="text-dark ">{{ $ps->street }}</div>
                            @endif
                            @if($ps->email != null)
                            <span class="h6 text-secondary mt-2">{{ __('Email :') }}</span>
                            <div class="text-dark ">{{ $ps->email }}</div>
                            @endif
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget category-widget mb-5">
                        ...
                        <ul>
                            ...
                            <li><a href="{{route('front.category', $cate->slug)}}{{!empty(request()->input('search')) ? '?search='.request()->input('search') : ''}}" class="text-dark">{{ $cate->name }}</a></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
                <div class="col-lg-2 col-md-6">
                    <div class="footer-widget category-widget mb-5">
                        ...
                        <ul>
                            @if($ps->home == 1)
                            <li>
                                <a href="{{ route('front.index') }}" class="text-dark">{{ __('Home') }}</a>
                            </li>
                            @endif
                            @if($ps->blog == 1)
                            <li>
                                <a href="{{ route('front.blog') }}" class="text-dark">{{ __('Blog') }}</a>
                            </li>
                                @endif
                                @if($ps->faq == 1)
                            <li>
                                <a href="{{ route('front.faq') }}" class="text-dark">{{ __('Faq') }}</a>
                            </li>
                            @endif
                            @foreach(DB::table('pages')->where('language_id',$langg->id)->where('footer','=',1)->get() as $data)
                            <li><a href="{{ route('front.vendor',$data->slug) }}" class="text-dark">{{ $data->title }}</a></li>
                            @endforeach
                            @if($ps->contact == 1)
                                <li>
                                <a href="{{ route('front.contact') }}" class="text-dark">{{ __('Contact Us') }}</a>
                            </li>
                                @endif
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget widget-nav mb-5">
                        ...
                        <div class="mt-4 payment_footer d-inline-flex align-items-center">
                            <img class="img-fluid first-img" src="{{url('/assets/images/razorpay.avif')}}" alt="razorpay">
                            <img class="img-fluid" src="{{url('/assets/images/master.svg')}}" alt="master">
                            <img class="img-fluid" src="{{url('/assets/images/visa.svg')}}" alt="visa">
                            <img class="img-fluid last-img" src="{{url('/assets/images/ssl.avif')}}" alt="ssl">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 text-left py-3">
                    <div class="sm-mb-10 d-block text-white">
                        <div class="nt-social border_true black_false d-flex align-items-center">
                            <a href="https://www.facebook.com/TheBhartians" target="_blank" class="facebook cb ttip_nt tooltip_bottom_right text-white">
                                <span class="tt_txt"></span><i class="fa fa-facebook"></i>
                            </a>
                            <a href="https://twitter.com/thebhartians" target="_blank" class="twitter cb ttip_nt tooltip_bottom_right text-white">
                                <span class="tt_txt"></span><i class="fa fa-twitter"></i>
                            </a>
                            <a href="https://www.instagram.com/thebhartians/" target="_blank" class="instagram cb ttip_nt tooltip_bottom_right text-white">
                                <span class="tt_txt"></span><i class="fa fa-instagram"></i>
                            </a>
                            <a href="https://www.pinterest.com/thebhartians/" target="_blank" class="ttip_nt tooltip_bottom_right text-white">
                ...
                <div class="col-md-6 py-3">
                    <span class="sm-mb-10 d-block text-white text-right">{{ $gs->copyright }}</span>
                </div>
            </div>
        </div>
    </div>
